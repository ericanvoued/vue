<template>
  <div>
        ...
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li v-for="(item, index) in addressListFilter" v-bind:class="{'check':checkIndex==index}"
                  ...
                  <div class="addr-opration addr-del" @click="delShowComfirm(item.addressId)">
                  ...
                  <div class="addr-opration addr-set-default" v-show="!item.isDefault">
                    <a href="javascript:;" class="addr-set-default-btn" @click="setDfault(item.addressId)"><i>Set
                      default</i></a>
                  </div>
            ...
            <div class="shipping-addr-more">
              <a class="addr-more-btn up-down-btn" href="javascript:;" @click="expandList()"
    ...
    <modal :mdShow = 'modalConfirm' v-on:close = 'closeModel()'>
      <p slot="message">
        您是否确认要删除此地址?
      </p>
      <div slot="btnGroup">
        <a class="btn btn--m" href="javascript:;" @click="delComfirm()">确认</a>
        <a class="btn btn--m btn--red" href="javascript:;"  @click = 'closeModel()'>取消</a>
      </div>
    </modal>
    <modal>
      <p slot="message">
      ...
      <div slot="btnGroup">
        <a class="btn btn--m btn--red" href="javascript:;">好的</a>
      </div>
    </modal>
